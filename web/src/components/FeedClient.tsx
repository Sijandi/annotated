      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition ${
            sort === "recent" ? "bg-blue-600 text-white" : "bg-zinc-900 text-zinc-400 hover:text-zinc-200"
          }`}
        >
          Recent
        </button>
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition ${
            sort === "trending" ? "bg-blue-600 text-white" : "bg-zinc-900 text-zinc-400 hover:text-zinc-200"
          }`}
        >
          Trending
        </button>
              ...
              >
                ...
                {a.source_type === "article" && a.clip_text && !thumbnailUrl && (
                  <div className="px-5 pt-5">
                    <blockquote className="border-l-2 border-blue-500 pl-3 text-sm text-zinc-300 italic line-clamp-3">
